    ...
    <el-dialog title="章节选择题" v-model="judgeFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="100px" :rules="judgeFormRules" ref="editForm">   
				<el-form-item label="题目名称"  prop="judgeName">
					<el-input v-model="editForm.judgeName" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item  prop="judgeOne" label="判断一">
					<el-input v-model="editForm.judgeOne" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item prop="judgeTwo" label="判断二">
					<el-input v-model="editForm.judgeTwo" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item prop="judgeAnswer" label="答案">
					<el-input v-model="editForm.judgeAnswer" type="text" auto-complete="off"></el-input>
				</el-form-item>
                <el-form-item prop="judgePoint" label="分值">
					<el-input v-model="editForm.judgePoint" type="text" auto-complete="off"></el-input>
					</el-form-item>
			    <el-form-item prop="selectValues" label="章节测试">       
				  <div class="block">
	 ...
	 <el-dialog title="期末测试选择题" v-model="judgeFormVisible2" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="100px" :rules="judgeFormRules" ref="editForm">   
			    ...
			    <el-form-item prop="selectValues" label="期末测试">       
	 ...
	 <el-dialog title="入学测试选择题" v-model="judgeFormVisible3" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="100px" :rules="judgeFormRules" ref="editForm">   
			    ...
			    <el-form-item prop="selectValues" label="入学测试">       
						...
						this.editLoading = true;
							...
							addCourseSection(para).then((res) => {
								...
								//this.$refs.editForm.resetFields();
              					 this.editForm.judgeName='',
								  this.editForm.judgeOne='',
								  this.editForm.judgeTwo='',
								  this.editForm.judgeAnswer='',
								  this.editForm.judgePoint='',
