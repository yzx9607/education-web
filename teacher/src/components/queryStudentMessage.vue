<template>
		<!--审核人员的审核学生详情(根据id)(my_311.vue里的详情的弹出层)-->
		<el-dialog title="学生报名信息详情" v-model="cardDetailVisible" :close-on-click-modal="false">
...
<script>
	import { getCheckQueryStudentMessage } from '../api/api';
	export default {
		data() {
			return {
		...
		methods: {
			...
			showCardDetail(row) {
				...
				getCheckQueryStudentMessage(para).then((res) => {
